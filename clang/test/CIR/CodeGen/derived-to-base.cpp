...
// CHECK:   cir.call @_ZN5buffyC2ERKS_(%3, %1) {cxx_ctor = #cir.cxx_ctor<"buffy">} : (!cir.ptr<!rec_buffy>, !cir.ptr<!rec_buffy>) -> ()
...
// Call @A::A(A const&)
// CHECK:     cir.call @_ZN1AC2ERKS_(%2, %3) {cxx_ctor = #cir.cxx_ctor<"class A">} : (!cir.ptr<!rec_A>, !cir.ptr<!rec_A>) -> ()
