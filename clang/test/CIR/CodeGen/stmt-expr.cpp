...
// CHECK:     cir.call @_ZN1AC1Ev(%[[#VAR]]) {cxx_ctor = #cir.cxx_ctor<"class A">} : (!cir.ptr<!rec_A>) -> ()
// CHECK:     cir.call @_ZN1AC1ERS_(%[[#RETVAL]], %[[#VAR]]) {cxx_ctor = #cir.cxx_ctor<"class A">}  : (!cir.ptr<!rec_A>, !cir.ptr<!rec_A>) -> ()
