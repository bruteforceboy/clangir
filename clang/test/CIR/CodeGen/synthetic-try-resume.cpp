...
// CIR: cir.call @_ZNSbIcED1Ev({{.*}}) {cxx_dtor = #cir.cxx_dtor<"class std::basic_string<char>">} : (!cir.ptr<!rec_std3A3Abasic_string3Cchar3E>) -> ()
// CIR: cir.try synthetic cleanup {
// CIR:   cir.call exception @_ZNSbIcEC1EPKcRKNS_9AllocatorE({{.*}}, {{.*}}, {{.*}})  {cxx_ctor = #cir.cxx_ctor<"class std::basic_string<char>">} : (!cir.ptr<!rec_std3A3Abasic_string3Cchar3E>, !cir.ptr<!s8i>, !cir.ptr<!rec_std3A3Abasic_string3Cchar3E3A3AAllocator>) -> ()
// CIR:   cir.yield
// CIR: } catch [#cir.unwind {
// CIR:   cir.resume
// CIR: }]
